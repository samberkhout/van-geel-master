...
export default function QSMGroeiPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            const uniekeSoorten = Array.from(new Set(transformedData.map(d => d.soort)));
    ...
    const updateChartData = (dataset: QSMGroei[], selectedSoorten: string[], startIndex: number, endIndex: number) => {
        ...
        const labels = Array.from(new Set(filteredData.map(d => d.jaarWeek)));
    ...
    const handleSliderChange = (newRange: [number, number]) => {
        ...
        updateChartData(data, selectedSoorten, newRange[0], newRange[1]);
    };
                                ...
                                <Line
                                    ...
                                    options={{
                                        ...
                                        scales: {
                                            ...
                                            y: { title: { display: true, text: "Groei (kg/week)" } }
                                        }
                                    }}
                                />
                            ) : (
